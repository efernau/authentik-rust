...
impl AuthenticatorWebAuthnChallenge {
    /// WebAuthn Challenge
    pub fn new(r#type: models::ChallengeChoices, pending_user: String, pending_user_avatar: String, registration: std::collections::HashMap<String, serde_json::Value>) -> AuthenticatorWebAuthnChallenge {

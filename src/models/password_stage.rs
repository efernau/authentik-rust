...
impl PasswordStage {
    ...
    pub fn new(pk: uuid::Uuid, name: String, component: String, verbose_name: String, verbose_name_plural: String, meta_model_name: String, backends: Vec<models::BackendsEnum>) -> PasswordStage {
        PasswordStage {
            pk,
            name,
            component,

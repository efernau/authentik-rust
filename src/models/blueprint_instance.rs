...
impl BlueprintInstance {
    ...
    pub fn new(pk: uuid::Uuid, name: String, last_applied: String, last_applied_hash: String, status: models::BlueprintInstanceStatusEnum, managed_models: Vec<String>, metadata: Option<serde_json::Value>) -> BlueprintInstance {
        BlueprintInstance {
            pk,
            name,
            path: None,

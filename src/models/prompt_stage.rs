...
impl PromptStage {
    ...
    pub fn new(pk: uuid::Uuid, name: String, component: String, verbose_name: String, verbose_name_plural: String, meta_model_name: String, fields: Vec<uuid::Uuid>) -> PromptStage {
        PromptStage {
            pk,
            name,
            component,

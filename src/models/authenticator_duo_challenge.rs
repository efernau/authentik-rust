...
impl AuthenticatorDuoChallenge {
    /// Duo Challenge
    pub fn new(r#type: models::ChallengeChoices, pending_user: String, pending_user_avatar: String, activation_barcode: String, activation_code: String, stage_uuid: String) -> AuthenticatorDuoChallenge {

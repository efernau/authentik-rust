...
pub struct PatchedLdapPropertyMappingRequest {
    ...
    #[serde(rename = "object_field", skip_serializing_if = "Option::is_none")]
    pub object_field: Option<String>,
}

impl PatchedLdapPropertyMappingRequest {
    /// LDAP PropertyMapping Serializer
    pub fn new() -> PatchedLdapPropertyMappingRequest {

...
impl ConsentChallenge {
    ...
    pub fn new(r#type: models::ChallengeChoices, pending_user: String, pending_user_avatar: String, permissions: Vec<models::ConsentPermission>, additional_permissions: Vec<models::ConsentPermission>, token: String) -> ConsentChallenge {
        ConsentChallenge {
            r#type,
            flow_info: None,
            component: None,

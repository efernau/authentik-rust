...
pub struct Outpost {
    ...
    pub service_connection_obj: Box<models::ServiceConnection>,
...
impl Outpost {
    /// Outpost Serializer
    pub fn new(pk: uuid::Uuid, name: String, r#type: models::OutpostTypeEnum, providers: Vec<i32>, providers_obj: Vec<models::Provider>, service_connection_obj: models::ServiceConnection, token_identifier: String, config: std::collections::HashMap<String, serde_json::Value>) -> Outpost {
        Outpost {
            pk,
            name,
            r#type,
            ...
            service_connection_obj: Box::new(service_connection_obj),
            token_identifier,
            config,
            managed: None,
        }
